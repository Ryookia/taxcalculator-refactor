...
class OrdinaryContractHandler(
    ...
    override fun executeContractProcess(taxDataHolder: TaxDataHolder) {
        sendMessage(StringResources.INFO_ORDINARY_CONTRACT.string)
        sendMessage(
        ...
        sendMessage(StringResources.FORMAT_CONSTANT_TAX_COST,
                calculatorEngine.provideIncomeCost(taxDataHolder).toString())
        ...
        sendMessage(StringResources.FORMAT_EXEMPTED_VALUE,
                taxConfig.exemptedValue.toString())
    ...
    private fun calculateResults(taxDataHolder: TaxDataHolder) {
        ...
        taxDataHolder.advancedTaxValue = preciseFormater.format(
